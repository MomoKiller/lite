        ...
        function () {
          ...
          _createClass(ChartManager, [{
            ...
            value: function scale(s) {
              ...
              // undefined 情况处理 200107 
              if (this._highlightedFrame === null || this._highlightedFrame === undefined) return;
      ...
      var Kline =
        ...
        function () {
          function Kline(option) {
            ...
            window.Control = __WEBPACK_IMPORTED_MODULE_0__control__["a" /* Control */];
          ...
          _createClass(Kline, [{
            ...
            value: function registerMouseEvent() {
              __WEBPACK_IMPORTED_MODULE_7_jquery___default.a.fn.longPress = function (fn) {
              ...
              __WEBPACK_IMPORTED_MODULE_7_jquery___default()(document).ready(function () {
                Kline.instance.chartMgr.setRunningMode(__WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].DrawingTool['Cursor']);
                ...
                __WEBPACK_IMPORTED_MODULE_7_jquery___default()("#chart_btn_parameter_settings").click(function () {
                  ...
                  // 打开配置项
                  document.getElementById('kline-background').style.display = "block";
                  document.getElementById('Kline-column').style.position = "unset";
                  // document.getElementsByClassName('chart_container')[0].style.position = 'absolute';
                });
                __WEBPACK_IMPORTED_MODULE_7_jquery___default()("#close_settings").click(function () {
                  ...
                  // document.getElementsByClassName('chart_container')[0].style.position = 'relative';
                });
                ...
                __WEBPACK_IMPORTED_MODULE_7_jquery___default()("#clearCanvas").click(function () {
                  Kline.instance.isLongPress = 'tap';
                  __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.onMouseUp("frame0", 100, 100);
                  var mgr = __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance;
                  mgr.onMouseMove("frame0", 101, 101, false);
                  mgr.redraw("OverlayCanvas");
                  __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.onMouseDown("frame0", 101, 101);
                  setTimeout(function () {
                    ...
                    __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.redraw('OverlayCanvas', false); // 回归无十字模式

                    setTimeout(function () {
                      var mgr = __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance;
                      Kline.instance.chartMgr.setRunningMode(__WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].DrawingTool['Cursor']);
                      mgr.onMouseMove("frame0", 100, 100, true);
                      mgr.redraw("All");
                    }, 200);
                  });
                }); // 长按显示十字坐标

                __WEBPACK_IMPORTED_MODULE_7_jquery___default()("#chart_overlayCanvas").longPress(function (e) {
                  if (Kline.instance.isLongPress !== 'tap') {
                    return;
                  }

                  if (__WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance._drawingTool > 1) {
                    return;
                  }

                  Kline.instance.isLongPress = 'press';
                  Kline.instance.chartMgr.setRunningMode(__WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].DrawingTool['CrossCursor']);
                  e = e.touches[0];
                ...
                __WEBPACK_IMPORTED_MODULE_7_jquery___default()("#chart_overlayCanvas").mouseleave(function (e) {
                  var r = e.target.getBoundingClientRect();
                  var x = e.clientX - r.left;
                  var y = e.clientY - r.top;
                  var mgr = __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance;
                ...
                __WEBPACK_IMPORTED_MODULE_7_jquery___default()("#chart_overlayCanvas").on('touchend', function (e) {
                  // 清空双手
                  Kline.instance.singleZoomCoorDinate.x = 0;
                  Kline.instance.singleZoomCoorDinate.y = 0;

                  if (__WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance._drawingTool === 0 || __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance._drawingTool === 1) {
                    Kline.instance.chartMgr.setRunningMode(__WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].DrawingTool['Cursor']);
                  }

                  Kline.instance.isLongPress = null;
                  var r = e.target.getBoundingClientRect();
                ...
                __WEBPACK_IMPORTED_MODULE_7_jquery___default()("#chart_overlayCanvas").on('touchstart', function (e) {
                  ...
                  var x = e.clientX - r.left;
                  var y = e.clientY - r.top;
                  __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.onMouseUp("frame0", x, y);
                  var mgr = __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance; // 判断 如果正在画线

                  console.log(__WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance._drawingTool);

                  if (__WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance._drawingTool !== 0 && __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance._drawingTool !== undefined) {
                    mgr.onMouseMove("frame0", x, y, false);
                    mgr.redraw("OverlayCanvas");
                    return;
                  } else {
                ...
                __WEBPACK_IMPORTED_MODULE_7_jquery___default()("#chart_overlayCanvas").on('touchmove', function (e) {
                  var touches = e.touches; // 判断 如果正在画线
                  ...
                  Kline.instance.isLongPress = Kline.instance.isLongPress === 'tap' || Kline.instance.isLongPress === 'tap-move' ? 'tap-move' : 'press-move'; // 单指触摸
                  ...
                  if (touches.length === 1) {
                    ...
                    var _x = e.clientX - _r.left;

                    var _y = e.clientY - _r.top;

                    var _mgr = __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance;

                    if ((Kline.instance.chartMgr._drawingTool === 0 || Kline.instance.chartMgr._drawingTool === undefined) && Kline.instance.isLongPress === 'tap-move') {
                      // 无十字坐标
                      _mgr.onMouseMove("frame0", _x, _y, true);

                      _mgr.redraw("All");
                    } else if (Kline.instance.isLongPress === 'press-move') {
                      // 有十字坐标
                      _mgr.onMouseMove("frame0", _x, _y, false);

                      _mgr.redraw("OverlayCanvas");
                    }
                  } // 双手指触摸
                  else if (touches.length === 2) {
                    e = touches;

                    if (Kline.instance.singleZoomCoorDinate.x !== 0 && Kline.instance.singleZoomCoorDinate.y !== 0) {
                      var _x2 = Math.abs(e[0].clientX - e[1].clientX);

                      var _y2 = Math.abs(e[0].clientY - e[1].clientY);

                      if (_x2 > Kline.instance.singleZoomCoorDinate.x + 3 || _y2 > Kline.instance.singleZoomCoorDinate.y + 3) {
                        window.ChartManager.instance.scale(1);
                      } else if (_x2 < Kline.instance.singleZoomCoorDinate.x - 3 || _y2 < Kline.instance.singleZoomCoorDinate.y - 3) {
                        window.ChartManager.instance.scale(-1);
                      }
                    }

                    Kline.instance.singleZoomCoorDinate.x = Math.abs(e[0].clientX - e[1].clientX);
                    Kline.instance.singleZoomCoorDinate.y = Math.abs(e[0].clientY - e[1].clientY);
                    var _mgr2 = __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance;
      ...
      var LightTheme =
        ...
        function (_Theme2) {
          ...
          function LightTheme() {
            ...
            _this2._colors[Theme.Color.Indicator3] = "#50a698";
        ...
        function () {
          ...
          _createClass(Control, null, [{
            ...
            value: function requestOverHttp() {
              ...
              Control.requestSuccessHandler(window.klineData); // $(document).ready(
              ...
              //                 Control.requestSuccessHandler(window.klineData);
              //             }
              //         },
            ...
            value: function onSize(w, h) {
              ...
              if (toolPanelShown) {
                mainCanvas.height = (canvasGroupRect.h - 32) * 2;
                overlayCanvas.height = (canvasGroupRect.h - 32) * 2;
                mainCanvas.style.top = '32px';
              ...
              overlayCanvas.width = chartWidth * 2;
              mainCanvas.width = chartWidth * 2;
